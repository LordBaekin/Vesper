	...
	public class UsableItem : Item
	{
        ...
        public override void Use()
        {
            if(this.m_ActionSequence == null)
                this.m_ActionSequence = new Sequence(InventoryManager.Current.GetPlayerInfo().gameObject, InventoryManager.Current.GetPlayerInfo(), InventoryManager.Current.GetPlayerInfo().gameObject.GetComponent<Blackboard>(), actions.Cast<IAction>().ToArray());
