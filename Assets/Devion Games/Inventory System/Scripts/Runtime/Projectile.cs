...
namespace DevionGames.InventorySystem
{
    public class Projectile : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            PlayerInfo player = InventoryManager.Current.GetPlayerInfo();
        ...
        private GameObject GetTarget() {
            ...
            if (this.m_SelectBestTarget) {
                ...
                GameObject from = InventoryManager.Current.GetPlayerInfo().gameObject;
        ...
        private void OnHit(Transform hit, Vector3 position) {
            ...
            EventHandler.Execute(InventoryManager.Current.GetPlayerInfo().gameObject, "SendDamage", hit.gameObject, this.m_Data); 
